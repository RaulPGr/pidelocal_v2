...
export default function HelpClient({ businessId }: { businessId: string }) {
    ...
    return (
        <div className="space-y-8 animate-in fade-in pb-20 max-w-7xl mx-auto relative">
            ...
            <button
                ...
                className="w-full py-2 bg-emerald-600 hover:bg-emerald-700 text-white rounded-lg font-medium transition-colors text-sm"
            >
                Contactar Soporte
            </button>
