                ...
                {product.allergens.map((algId) => {
                  ...
                  return (
                    <div
                      key={algId}
                      title={alg.label}
                      className="text-slate-400 bg-slate-50 p-0.5 rounded border border-slate-100"
                    >
                      {/* @ts-ignore */}
                  ...
                  {group.options.map((opt) => {
                    ...
                    return (
                      <label
                        key={opt.id}
                        htmlFor={inputId}
                        className={`flex cursor-pointer items-center justify-between rounded border px-3 py-2 text-sm ${checked ? "border-emerald-400 bg-emerald-50" : "border-slate-200 bg-white"
                          }`}
                      >
