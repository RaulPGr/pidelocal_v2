...
// Calculate specific quantity for this product (simple products usually don't have variants, but we sum just in case)
...
function onDec(e: React.MouseEvent) {
  e.stopPropagation();
  // For simple products, dec just removes one. 
  // If there are multiple entries (rare for simple), we dec the last one or by ID if specific.
  // Ideally we assume simple products have one entry if no options. 
  // We'll use the first matching item found to decrement.
