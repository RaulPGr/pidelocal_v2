...
export default function CategoryNav({ sections }: { sections: Section[] }) {
    ...
    return (
        <div className="sticky top-[63px] md:top-[71px] z-40 bg-white/95 backdrop-blur-xl border-y border-slate-200/50 shadow-sm transition-all duration-300 supports-[backdrop-filter]:bg-white/80">
